...
let fakegif = { key: {participant: `0@s.whatsapp.net`, ...("62837x39077-161x9930@g.us" ? { remoteJid: "62896x439077-160x49930@g.us" } : {})},message: {"videoMessage": { "title": '*${wm}* 🍁⃨፝⃕✰', "h": `Hmm`,'seconds': '99999', 'gifPlayback': 'true', 'caption': `*${wm}*`, 'jpegThumbnail': false }}}
